...
if(!$nitProve=="" && !$nameProve=="" && !$dirProve=="" && !$telProve=="" && !$webProve==""){
    ...
    if($verificaltotal<=0){
        ...
        echo '<img src="assets/img/incorrecto.png" class="center-all-contens"><br><p class="lead text-center">El RFC que ha ingresado ya existe.<br>Por favor ingrese otro número de RFC</p>';
    }
}else {
